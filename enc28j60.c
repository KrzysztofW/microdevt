#include <avr/io.h>
               ...
               # Replace Windows newlines with Unix newlines#include "config.h"
               ...
               # Replace Windows newlines with Unix newlines
               # Replace Windows newlines with Unix newlinesvoid cs_on(void)
               # Replace Windows newlines with Unix newlines{
               # Replace Windows newlines with Unix newlines	SPI_PORT &= ~(1<<SPI_CS);
               # Replace Windows newlines with Unix newlines}
               # Replace Windows newlines with Unix newlines
               # Replace Windows newlines with Unix newlinesvoid cs_off(void)
               # Replace Windows newlines with Unix newlines{
               # Replace Windows newlines with Unix newlines	SPI_PORT |= (1<<SPI_CS);
               # Replace Windows newlines with Unix newlines}
               # Replace Windows newlines with Unix newlines
               # Replace Windows newlines with Unix newlinesvoid wait_spi(void)
               # Replace Windows newlines with Unix newlines{
               ...
               # Replace Windows newlines with Unix newlines{
               # Replace Windows newlines with Unix newlines    cs_on();
               # Replace Windows newlines with Unix newlines    SPDR = op | (address & ADDR_MASK);
               # Replace Windows newlines with Unix newlines    wait_spi();
               ...
               # Replace Windows newlines with Unix newlines        wait_spi();
               # Replace Windows newlines with Unix newlines    }
               # Replace Windows newlines with Unix newlines    cs_off();
               ...
               # Replace Windows newlines with Unix newlines{
               # Replace Windows newlines with Unix newlines    cs_on();
               # Replace Windows newlines with Unix newlines    SPDR = SC;
               # Replace Windows newlines with Unix newlines    wait_spi();
               # Replace Windows newlines with Unix newlines    cs_off();
               # Replace Windows newlines with Unix newlines}
               # Replace Windows newlines with Unix newlines
